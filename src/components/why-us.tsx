...
export default function WhyUs() {
    return <section className="w-full flex flex-wrap items-center bg-yellow-normal px-spacing-normal py-10 relative before:h-80 before:w-80 before:left-0 before:absolute before:bg-red-normal before:rounded-full before:-translate-x-1/2">
