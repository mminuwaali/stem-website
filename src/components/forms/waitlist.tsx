...
export default function WaitlistForm() {
    ...
    return <form onSubmit={handleSubmit} className="w-80 md:w-96 relative p-10 py-14 bg-black rounded-xl flex flex-col items-center gap-4 text-white">
        <img src={smilyIcon} alt="" className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 h-20" />
        ...
        <button className="px-10 py-1.5 rounded-full bg-yellow-600 self-center">Join Now</button>
    </form >
}